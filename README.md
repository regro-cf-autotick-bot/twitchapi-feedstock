...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/twitchapi-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14352&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/twitchapi-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `twitchapi` can be installed with:

```
conda install twitchapi
```

It is possible to list all of the versions of `twitchapi` available on your platform with:
